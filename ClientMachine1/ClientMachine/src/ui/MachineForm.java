...
public class MachineForm extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            for (Machine m : dao.findAll())
                model.addRow(new Object[]{
                    ...
                    m.getMarque(),
                    m.getPrix(),
                    m.getSalle().getId() // Changed to get Salle ID
                });
    ...
    public MachineForm() {
        initComponents();
        try {
            dao = (IDao<Machine>) Naming.lookup("rmi://localhost:1098/machine");
            salles = (IDao<Salle>) Naming.lookup("rmi://localhost:1098/salle");
    ...
    public void loadSalle() {
        try {
            ...
            for (Salle s : salleList) {
                jComboBox.addItem(s); // Add Salle objects to the JComboBox
            }
        } catch (RemoteException ex) {
            Logger.getLogger(MachineForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void bnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnAddActionPerformed
        try {
            ...
            Salle salle = (Salle) jComboBox.getSelectedItem();
